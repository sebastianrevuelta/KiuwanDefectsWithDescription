...
public class SourceRootSimpleRestData {
  ...
  public SourceRootSimpleRestData path(String path) {
    this.path = path;
    return this;
  }
  ...
  **/
  ...
  public SourceRootSimpleRestData artifact(String artifact) {
  ...
  **/
  ...
  public SourceRootSimpleRestData version(String version) {
  ...
  **/
  ...
  public SourceRootSimpleRestData child(List<SourceChildSimpleRestData> child) {
    this.child = child;
    return this;
  }

  public SourceRootSimpleRestData addChildItem(SourceChildSimpleRestData childItem) {
    if (this.child == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SourceRootSimpleRestData sourceRootSimpleRestData = (SourceRootSimpleRestData) o;
    return Objects.equals(this.path, sourceRootSimpleRestData.path) &&
        Objects.equals(this.artifact, sourceRootSimpleRestData.artifact) &&
        Objects.equals(this.version, sourceRootSimpleRestData.version) &&
        Objects.equals(this.child, sourceRootSimpleRestData.child);
  }

  @Override
  public int hashCode() {
    return Objects.hash(path, artifact, version, child);
  }
